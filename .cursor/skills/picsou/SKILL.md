...
For **designing a new workflow** (waves of questions → scenario brief), use
...
- Report canvases and recommendation chrome are **English only** (no French UI,
  no Infobulles/legend banner). Enforced by `test/canvas-english.test.mjs`.
